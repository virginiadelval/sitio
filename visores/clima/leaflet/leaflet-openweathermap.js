...
L.OWM = L.TileLayer.extend({
	options: {
		appId: "http://api.openweathermap.org/data/2.5/weather?q=Salta,ar&APPID=03c820e325942ff0dd30b52dc0e14238", /* pass your own AppId as parameter when creating the layer. Get your own AppId at https://www.openweathermap.org/appid */
		baseUrl: "https://{s}.tile.openweathermap.org/map/{clouds}/{z}/{x}/{y}.png",
		maxZoom: 18,
		showLegend: true,
...
L.OWM.Current = L.Layer.extend({
	...
	options: {
		appId: 'http://api.openweathermap.org/data/2.5/weather?q=Salta,ar&APPID=03c820e325942ff0dd30b52dc0e14238', // get your free Application ID at www.openweathermap.org
		...
		minZoom: 7,
		interval: 10, // interval for rereading city data in minutes
		...
		imageWidthPlane: 25,
		imageHeightPlane: 25,
		markerFunction: false, // user defined function for marker creation
		popupFunction: false, // user defined function for popup creation
